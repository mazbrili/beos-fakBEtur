...
");\n"
"\n"
"INSERT INTO vat_rate (id, name, stawka, aktywne) VALUES (1, '0%', 0, 1);\n"
"INSERT INTO vat_rate (id, name, stawka, aktywne) VALUES (2, '3%', 3, 1);\n"
"INSERT INTO vat_rate (id, name, stawka, aktywne) VALUES (3, '7%', 7, 1);\n"
"INSERT INTO vat_rate (id, name, stawka, aktywne) VALUES (4, '22%', 22, 1);\n"
"INSERT INTO vat_rate (id, name, stawka, aktywne) VALUES (5, 'zwolnione', 0, 1);\n"
"\n"
"CREATE TABLE firma (\n"
"	id			INTEGER NOT NULL,\n"
"	name		TEXT,\n"
...
");\n"
"--- vatid points to vat_rate table\n"
...
"\n"
"	notatki 	TEXT,\n"
"	magazyn		DECIMAL(12,2) NOT NULL DEFAULT 0,\n"
"	magzmiana	DATETIME,\n"
"	PRIMARY KEY(id,symbol)\n"
");\n"
"\n"
...
"\n"
"	--- commodity - kopia struktury z commodity\n"
"	name		TEXT,\n"
"	pkwiu		TEXT,\n"
"	jm			TEXT,\n"
"\n"
...
"	bank		TEXT,\n"
"	konto		TEXT,\n"
"--- configuration wydruku\n"
"	p_mode		INTEGER NOT NULL DEFAULT 0,\n"
...
"	i_numcopy	INTEGER NOT NULL DEFAULT 1,\n"
"--- configuration faktur\n"
"	f_wystawil	TEXT,\n"
"	f_numprosta	INTEGER NOT NULL DEFAULT 0,\n"
"	paydays		INTEGER NUT NULL DEFAULT 30,\n"
"--- marker\n"
"	version		TEXT DEFAULT '" APP_DBVERSION "',\n"
"	done	INTEGER DEFAULT 1\n"
");\n"
"\n"
"INSERT INTO configuration (done) VALUES (1);\n"
"\n"
;
